        ...
        <!-- <div class="cont"> -->
            ...
            <div class="category_section">
                <?php foreach($category as $row){ //print_r($row); ?>
                    <input type="hidden" id="c_id" value="<?php echo $row['subc_id'];?>">
                                                ...
                                                <div class="product_content text-left">
                                                    <div class="pro_grid">
                                                        ...
                                                        <div class="price_cart clearfix">
                                                            <div class="price_box">
                                                                <p class="product-card" data-price="514.00">$<?php echo $data['sale_price']; ?></p>
                                                            </div>
                                                            <!-- <div class="btn_info">
                                                                <a href="<?php //if($this->session->userdata('user_id')) {
                                                                    echo base_url('index.php/Product/product/'.$data['p_id']);
            ...
            <?php } else{?>
                <h2 style="padding : 100px 0px;"><center>Subcategory Empty...</center></h2>
            <?php } ?> 
...
$(document).ready(function(e){ 
    ...
    // });
        $('#min_price').change(function(){  
            var price = $(this).val();  
            var subc_id = $('#c_id').val();
            //alert(price);
            $("#price_range").text("Product under Price Rs. : " + price);  
            $.ajax({  
                    url:"<?php echo site_url('Sorting/scategories_filter'); ?>",  
                    method:"POST",  
                    data:{price:price,subc_id:subc_id},  
        ...
        $('#price-sorting').on('change',function()
        {
            ...
            { //alert('yes');
                $.ajax({
                    url:"<?php echo site_url('Sorting/lowtohigh_subcategory'); ?>",  
                    method:"POST",  
                ...
                $.ajax({
                    url:"<?php echo site_url('Sorting/hightolow_subcategory'); ?>",  
                    method:"POST",  
                    data:{c_id:c_id,sort:sort},  
                    success:function(data){  
                        //alert(data);
