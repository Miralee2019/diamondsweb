...
<body>
    <div class="forgot_password">
        <div class="forgot_confirm">
            <div class="head">
                <h2><span>User</span>Detail</h2>
            </div>
            <div class="group newpass">
                <label for="pass" class="label">email ID</label> 
                <input id="newpass" type="password" name="email" class="input" data-type="password" placeholder="Enter new password">
            </div>
            <div class="group confirmpass">
                <label for="pass" class="label">Your OTP</label> 
                <input id="confirmpass" type="password" name="otp" class="input" data-type="password" placeholder="Enter confirm password">
            </div>
