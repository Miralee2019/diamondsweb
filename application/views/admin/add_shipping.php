            ...
            <form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                ...
                <div class="controls" style="max-width:300px;">
                  <input type="text" name="shipping" id="shipping" class="form-control" value="<?php echo @$shipping['shipping_name']; ?>">
                  <label style="color: red"><?php echo form_error('shipping'); ?></label>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" style="float:left; text-align: right;">Rate</label>
                <div class="controls" style="max-width:300px;">
                  <input type="text" name="rate" id="rate" class="form-control" value="<?php echo @$shipping['shipping_rate']; ?>">
