          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                <label class="control-label" style="float:left; text-align: right;">First Name</label>
                <div class="controls" style="max-width:300px;">
                  <input type="text" name="fname" id="required" class="form-control">
                  <label style="color: red"><?php echo form_error('fname'); ?></label>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" style="float:left; text-align: right;">Email</label>
                <div class="controls" style="max-width:300px;">
              ...
              <div class="control-group">
                <label class="control-label" style="float:left; text-align: right;">Password</label>
                <div class="controls" style="max-width:300px;">
