          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                      <label class="control-label" style="float:left; text-align: right;">Select State</label>
              ...
              <div class="control-group">
                  <label class="control-label" style="float:left; text-align: right;">City Name</label>
                  <div class="controls" style="max-width:300px;">
                    <input type="text" name="city" id="required" class="form-control">
