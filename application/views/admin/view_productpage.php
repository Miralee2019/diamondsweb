      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>View Product</h5>
            <span style="float:right;" class="icon"><a href="<?php echo base_url('index.php/admin/Admin/addproduct'); ?>"><i class="icon-plus" title="Add Product"></i></a></span>
          </div>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><?php $img = explode(',',$data['image']); foreach ($img as $m) { ?>
                     <img src="<?php echo base_url('assets/images/'.$m);?>" style="width:100px;">
                      <?php } ?></td>
                    <td><?php echo $data['weight']; ?></td>
                    <!-- <td align="center"><a href="<?php echo site_url('admin/Admin/view_sale/'.$data['p_id'].'/1'); ?>"><?php if($data['sale']=='0'){?>
                        <img src="<?php echo base_url('assets/images/disapprove.png')?>" width="30px"></a><?php }else { ?>
                        <a  href="<?php echo site_url('admin/Admin/view_sale/'.$data['p_id'].'/0'); ?>">
                        <img src="<?php echo base_url('assets/images/approve.png')?>" width="30px"/></a><?php } ?>
                    </td> -->
                    <!-- <td align="center"><a href="<?php //echo site_url('admin/Admin/delete_product/'.$data['p_id'].'/'.$data['image']);?>" />-->                  
                    <?php $imgs = explode(',',$data['image']); //print_r($imgs);?>
                    <td align="center"><a href="<?php echo site_url('admin/Admin/delete_product/').$data['p_id']?>" />
                        <img src=<?php echo base_url ('assets/images/delete.png');?> width="30" height="30" /></a>
                    </td>   
                    <td align="center"><a href="<?php echo site_url('admin/Admin/update_product/'.$data['p_id']); ?>" />
