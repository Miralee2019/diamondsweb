        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php foreach($categories as $data){ //print_r($data);?>
                <tr class="odd gradeX">
                    <td><?php echo $data['categories_name']; ?></td>
                    <td>
                     <img src="<?php echo base_url('assets/images/'.$data['images']);?>" style="width:100px;">
                    </td>
                    <td align="center"><a href="<?php echo site_url('admin/Admin/delete_categories/').$data['id'].'/'.$data['images']?>" />
                        <img src=<?php echo base_url ('assets/images/delete.png');?> width="30" height="30" /></a>
                    </td>   
                    <!-- <td align="center"><a href="<?php echo site_url('admin/Admin/update_product/'.$data['id']); ?>" />
