      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>View Product</h5>
            <span style="float:right;" class="icon"><a href="<?php echo base_url('index.php/admin/Login/registration'); ?>"><i class="icon-plus" title="Add Admin"></i></a></span>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php foreach($admin as $data){ //print_r($data);?>
                <tr class="odd gradeX">
                    <td><?php echo $data['fname']; ?></td>
                    <td><?php echo $data['email']; ?></td>
                    <td align="center"><a href="<?php echo site_url('admin/Admin/delete_admin/').$data['id']?>" />
