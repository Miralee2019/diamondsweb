            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><?php echo $data['shipping_rate']; ?></td>
                    <td align="center"><a href="<?php echo site_url('admin/Admin/delete_shipping/').$data['shipping_id']?>" />
                        <img src=<?php echo base_url ('assets/images/delete.png');?> width="30" height="30" /></a>
                    </td>   
                    <td align="center"><a href="<?php echo site_url('admin/Admin/update_shipping/'.$data['shipping_id']); ?>" />
