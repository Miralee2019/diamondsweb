      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>View Product</h5>
            <span style="float:right;" class="icon"><a href="<?php echo base_url('index.php/admin/Admin/addcategories'); ?>"><i class="icon-plus" title="Add Categories"></i></a></span>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php foreach($subcategories as $data){ //print_r($data); ?>
                <tr class="odd gradeX">
                    <td><?php echo $data['categories_name']; ?></td>
                    <td><?php echo $data['subcategories_name']; ?></td>
                    <!-- <td>
                     <img src="<?php echo base_url('assets/images/'.$data['images']);?>" style="width:100px;">
                    </td> -->
                    <td align="center"><a href="<?php echo site_url('admin/Admin/delete_subcategories/').$data['subc_id']?>" />
                        <img src=<?php echo base_url ('assets/images/delete.png');?> width="30" height="30" /></a>
                    </td>   
                    <!-- <td align="center"><a href="<?php echo site_url('admin/Admin/update_product/'.$data['subc_id']); ?>" />
